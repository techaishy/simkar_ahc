...
export default function MonthYearDropdown({ onChange }: Props) {
  ...
  <select
    className="w-full rounded-lg border border-gray-300 bg-gray-100 text-gray-500 px-4 py-3 text-base focus:outline-none focus:ring-2 focus:ring-amber-500 focus:border-transparent"
    value={selectedMonth}
