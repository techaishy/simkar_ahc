      ...
      <div className="order-1 sm:order-2 flex justify-end w-full sm:w-auto">
        <Dialog open={openTambah} onOpenChange={setOpenTambah}>
          ...
          <DialogContent className="bg-gradient-to-br from-black via-gray-950 to-gray-800 sm:max-w-3xl">
            ...
            <TambahWilayahForm onSave={handleSave} onClose={() => setOpenTambah(false)} />
          </DialogContent>
        </Dialog>
      </div>
    </div>
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-xl p-2 pt-1 mb-8">
          <div className="flex items-center gap-3 mb-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-800">Wilayah Kerja Kesehatan Aceh</h1>
              <p className="text-gray-600 mt-1">Pilih kota/kabupaten untuk melihat detail fasilitas kesehatan</p>
            </div>
          </div>
            ...
            {currentItems.map((kota) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  >
                    Lihat Detail <ArrowRight className="w-4 h-4 group-hover/btn:translate-x-1 transition-transform" />
                  </button>
                </div>
              </div>
            ))}
