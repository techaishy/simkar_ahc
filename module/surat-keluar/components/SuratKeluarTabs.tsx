...
//       icon: FileText,
//       color: "bg-gradient-to-br from-black to-gray-900 hover:from-[#d2e67a] hover:to-[#f9fc4f] transition-all duration-300  hover:bg-blue-100 border-blue-200"
//     },
//     {
...
//       icon: Package,
//       color: "bg-gradient-to-br from-black to-gray-900 hover:from-[#d2e67a] hover:to-[#f9fc4f] transition-all duration-300 border-green-200"
//     }
//   ];
...
//               >
//                 <Card className={`${item.color} border text-white hover:text-black `}>
//                   <div className="p-6 ">
...
import { useState } from "react";
import { Card } from "@/components/ui/card";
import { FileText, Package, ArrowLeft, Plane } from "lucide-react";
